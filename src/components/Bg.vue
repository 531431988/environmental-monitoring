<template>
  <div class="absolute left-0 right-0 top-64 bottom-0 z-0" ref="canvas">
  </div>
</template>
...
class HLContainer { // Class qui va contenir nos halos lumineux et mettre à jour le style de l'élément HTML
  ...
  render () {
    ...
    backgroundStyle += "linear-gradient(" + this.direction + "45deg, #000009 0%, #00166C 100%)";
...
onMounted(() => {
  htmlContainer = canvas.value;
  console.log(htmlContainer, 123)
