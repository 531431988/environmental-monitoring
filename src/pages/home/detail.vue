<template>
  <div class="flex flex-col p-24">
    <a-row :gutter="[24, 24]" class="flex-1">
      <a-col :span="8">
        <Card title="数据采集-今日" class="h-full">
          <Chart :title="chartData.title" :data="chartData.data" color="#23AF98" />
        </Card>
      </a-col>
      <a-col :span="8">
        <Card title="数据采集-7日" class="h-full">
          <Chart :title="chartData.title" :data="chartData.data" />
        </Card>
      </a-col>
      <a-col :span="8">
        <Card title="设备信息" class="h-full">
          <Info />
        </Card>
      </a-col>
      <a-col :span="14">
        <Card title="数据采集-30日" style="height: calc(100% - 24px)">
