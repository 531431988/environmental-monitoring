  ...
  <div class="flex flex-col px-16 pt-10 pb-16 h-full">
    <a-row :gutter="16" class="h-full">
      <a-col :span="8" class="h-1/2">
        <Card title="数据采集-今日">
          <Chart mode="2" :title="title" :data="dailyQuery" color="#23AF98" :height="234" :type="$route.query.type" />
        </Card>
      </a-col>
      <a-col :span="8" class="h-1/2">
        <Card title="数据采集-7日">
          <Chart mode="2" :title="title" :data="weeklyQuery" :height="234" :type="$route.query.type" />
        </Card>
      </a-col>
      <a-col :span="8" class="h-1/2">
      ...
      <a-col :span="14" class="h-1/2">
        <Card title="数据采集-30日">
          <Chart mode="2" :title="title" :data="monthlyQuery" color="#00C4F6" :height="252" :type="$route.query.type" />
        </Card>
      </a-col>
